...
$(function() {
    ...
    */
    ...
    describe('The menu', function() {
         ...
         * by default. You'll have to analyze the HTML and
         ...
         * when the menu icon is clicked. This test should
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done) {
            loadFeed(0, function() {
                previousTitle = document.querySelector('.feed').innerHTML; 
                loadFeed(1, done); 
            });
        });

        it('changes the content', function() {
            const currentTitle = document.querySelector('.feed').innerHTML; 
            expect(currentTitle === previousTitle).toBe(false); 
        })
    });
}());
